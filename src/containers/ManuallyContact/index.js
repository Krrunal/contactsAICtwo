...
class addmanuallyContact extends Component {
 ...
 if (this.state.status == true) {
  if( first_name!=="" || middle_name!=="" || last_name!=="" || nick_name!==""
  || number1!=="" || number2!=="" || number3!=="" || email1!=="" || email2!=="" 
  || address1!=="" || messenger1!=="" || messenger2!=="" || social_media1!=="" 
  || social_media2!=="" || website1!=="" || website2!=="" || dob!=="" 
  || note!=="" || company!=="" || job_title!=="" || work_hour!==""
){
addManualContact(
 user_id,
 profile_image,
 ...
 const profile_image = image.path.substring(image.path.lastIndexOf("/") + 1);
