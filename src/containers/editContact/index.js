  ...
  export default class addmanuallyContact extends Component {
    ...
    componentDidMount() {
        this.setState({
            ...
            middle_name: this.props.route.params.middle_name,
            last_name: this.props.route.params.last_name,
            nick_name: this.props.route.params.nick_name,
            number1: this.props.route.params.number1,
            number2: this.props.route.params.number2,
            number3: this.props.route.params.number3,
            email1: this.props.route.params.email1,
            email2: this.props.route.params.email2,
            address: this.props.route.params.address,
            messenger1: this.props.route.params.messenger1,
            messenger2: this.props.route.params.messenger2,
            social_media1: this.props.route.params.social_media1,
            social_media2: this.props.route.params.social_media2,
            website1: this.props.route.params.website1,
            website2: this.props.route.params.website2,
            dob: this.props.route.params.dob,
            note: this.props.route.params.note,
            company: this.props.route.params.company,
            job_title: this.props.route.params.job_title,
            work_hour: this.props.route.params.work_hour,
        })
    }
    renderHeader() {
      return (
          ...
          <View style={styles.blueView}>
            <View style={{width: width * 0.9, flexDirection: 'row'}}>
              ...
              <View style={styles.sidebarViewCenter}>
                <Text style={styles.centerText}>Edit Contact</Text>
              </View>
    ...
    editToFirebase() {
        // alert(this.state.id);
        firebase.firestore().collection('1').doc(`${this.state.id}`).update({
        ...
        messenger1: this.state.messenger1,
        messenger2: this.state.messenger2,
        social_media1: this.state.social_media1,
        social_media2: this.state.social_media2,
      ...
      return (
        ...
        />
          ...
          <View
            ...
            <TouchableHighlight style={styles.saveView} underlayColor='transparant' onPress={() => this.editToFirebase()}>
