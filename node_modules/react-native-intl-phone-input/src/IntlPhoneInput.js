  ...
  render() {
   ...
   {this.props.isLogin == false || this.props.isShowLabel == false ?
       <View style={{ ...styles.containerLogin, ...containerStyle }}>
            <View>
                <Text style={{ fontSize: width * 0.024,fontFamily: Font.regular,color: COLORS.main_text_color, marginLeft: Metrics.baseMargin, marginTop: 1}}>Phone Number</Text>
            </View>
           <View style={{flexDirection:'row'}}>
            {/* {this.props.isMyContact == false ? 
               null
            :
